/*
    ...
    NAME: Postal Areas ASGS Edition 2021 in .csv Format 
    DOWNLOAD: https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/allocation-files/POA_2021_AUST.xlsx
    DOCUMENT: POA_2021_AUST.csv
    
    NAME: Suburbs and Localities - 2021 ASGS Edition 2021 in .csv Format 
    DOWNLOAD: https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/allocation-files/SAL_2021_AUST.xlsx
    DOCUMENT: SAL_2021_AUST.csv
*/

const fs = require('fs')

const POA_DATA_FILE = 'POA_2021_AUST.csv'
const SSC_DATA_FILE = 'SAL_2021_AUST.csv'
const STATE_CODES = {
  1: 'NSW',
  2: 'VIC',
  3: 'QLD',
